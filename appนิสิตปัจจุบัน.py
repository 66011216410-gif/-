...
# พื้นหลังเว็บจากภาพอาคาร — แสดงเป็นพื้นหลังของหน้า Streamlit โดยตรง
st.markdown(
    """
    <style>
    .stApp {
